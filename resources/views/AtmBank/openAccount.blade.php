            ...
            <div class="row justify-content-center align-items-center g-2">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="lastname" id="lastname" value="{{old('lastnaem')}}
                            placeholder=" Alawa">
                    </div>
                </div>
            </div>
            <div class="row justify-content-center align-items-center g-2">
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" name="contact_number" id="contact_number" value="{{old('contact_number')}}">
                    </div>
                </div>
                <div class="col">
                    <div class="mb-3">
                        <label for="gender" class="form-label">Data Of Birth</label>
